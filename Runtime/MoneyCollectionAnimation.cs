...
{
    public class MoneyCollectionAnimation : MonoBehaviour
    {
        ...
        public void ShowMoneyEffect(Vector3 worldPosition, double amount, bool multible)
        {
            ...
            {
                ShowSingleMoneyEffect(worldPosition, amount);
            }
        }



        private void ShowSingleMoneyEffect(Vector3 worldPosition, double amount)
        {
