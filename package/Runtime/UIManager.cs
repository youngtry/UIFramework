...
namespace UIFramework
{
    ...
    public class CollectionAnimationData
    {
        ...
        public CollectionAnimationData(List<GameObject> target, Vector3 startPosition,Transform targetTransform, bool isMultiple, string amountStr)
        {
            this.target = target;
    ...
    public class UIManager : SingletonMonoBehaviour<UIManager>
    {
        ...
        public void ShowCollectionEffect(CollectionAnimationData data)
        {
            ...
            {
                if (!collectionAnimations[i].isPlaying)
                {
        ...
        public void ShowAddTextEffect(Vector3 targetPos, string text)
        {
            ...
            {
                if (!addTextAnimations[i].isPlaying)
                {
